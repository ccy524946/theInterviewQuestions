...
​	[1.17new String("abc")？](java基础/1.17newString("abc").md)

​	[1.18string有重写 Object的 hashcode和 toString吗?如果重写 equals不重写 hashcode会出现什么问题？](java基础/1.18string有重写Object的hashcode和toString吗如果重写equals不重写hashcode会出现什么问题.md)

​	[1.19String中的"+"是如何实现的？](java基础/1.19String中的"+"是如何实现的.md)

​	[1.20Java如何进行文件读取？](java基础/1.20Java如何进行文件读取.md)

​	[1.21反射？](java基础/1.21反射.md)
...
​	[1.28equals和==(2)？](java基础/1.28equals和==(2).md)
